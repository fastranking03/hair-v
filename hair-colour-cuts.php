...
<head>
    ...
    <title>HAIR BY LADY H | Colour & Cuts Details</title>
...
<body>
    ...
    <main class="min-h-[80vh]">
        <section class="py-20 md:py-32 bg-white">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <h1 class="font-luxury-serif text-6xl text-center mb-4 text-dark-orchid">Colouring & Cutting</h1>
                <p class="text-center text-gray-600 mb-12 border-b border-gray-300 pb-8">
                    Discover our precision cutting techniques and bespoke colour services, designed for lasting radiance.
                </p>

                <div class="bg-dark-section p-6 border-l-4 border-dark-orchid mb-12 shadow-md">
                    <p class="text-lg font-luxury-serif text-dark-orchid mb-2">Consultation & Guidelines</p>
                    <p class="text-sm text-gray-600">
                        **Patch Test Required:** Strand test & Patch test is required 24-48 hours before the appointment. Home services are available. Final price for complex color confirmed after consultation.
                    </p>
                </div>

                <div class="mb-16">
                    <h3 class="font-luxury-serif text-3xl text-dark-orchid border-b border-gray-200 pb-2 mb-6">Hair Colour Services</h3>
                    <div class="space-y-1 bg-dark-section p-4 shadow-sm">
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Full head colour</span>
                                <span class="text-xs text-gray-500">Takes approximately 2.5 hours</span>
                            </div>
                            <span class="text-dark-orchid">From £80</span>
                            <button onclick="openBookingModal('Full head colour', '80')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Roots Retouch (8 week regrowth)</span>
                                <span class="text-xs text-gray-500">Takes approximately 2 hours</span>
                            </div>
                            <span class="text-dark-orchid">From £60</span>
                            <button onclick="openBookingModal('Roots Retouch', '60')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Balayage or Full Head Highlights + Base colour</span>
                                <span class="text-xs text-gray-500">Takes approximately 4–8 hours</span>
                            </div>
                            <span class="text-dark-orchid">From £100</span>
                            <button onclick="openBookingModal('Balayage', '100')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Toner</span>
                                <span class="text-xs text-gray-500">Takes approximately 4–8 hours</span>
                            </div>
                            <span class="text-dark-orchid">From £50</span>
                            <button onclick="openBookingModal('Toner', '50')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                    </div>
                </div>

                <div class="mb-16">
                    <h3 class="font-luxury-serif text-3xl text-dark-orchid border-b border-gray-200 pb-2 mb-6">Hair Cuts & Blow Dries</h3>
                    <div class="space-y-1 bg-dark-section p-4 shadow-sm">
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Basic Cut + Wash + Blow Dry</span>
                                <span class="text-xs text-gray-500">Takes approximately 1.5 hours</span>
                            </div>
                            <span class="text-dark-orchid">£35</span>
                            <button onclick="openBookingModal('Basic Cut', '35')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Luxury Cut (Layers + Face Framing) + Wash + Blow Dry</span>
                                <span class="text-xs text-gray-500">Takes approximately 2 hours</span>
                            </div>
                            <span class="text-dark-orchid">£45</span>
                            <button onclick="openBookingModal('Luxury Cut', '45')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                         <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Face Framing</span>
                                <span class="text-xs text-gray-500">Takes approximately 15 mins</span>
                            </div>
                            <span class="text-dark-orchid">£10</span>
                            <button onclick="openBookingModal('Face Framing', '10')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Children's Cut (6-11 Years Old)</span>
                                <span class="text-xs text-gray-500">Time Varies (Consultation Required)</span>
                            </div>
                            <span class="text-dark-orchid">£25</span>
                            <button onclick="openBookingModal('Children\'s Cut', '25')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Dry Cut</span>
                                <span class="text-xs text-gray-500">Takes approximately 45 mins</span>
                            </div>
                            <span class="text-dark-orchid">£15</span>
                            <button onclick="openBookingModal('Dry Cut', '15')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                    </div>
                </div>
                ...
                <div id="step-2" class="booking-step">
                    ...
                    <form>
                        ...
                        <div class="flex gap-4 mb-4">
                            <input type="text" placeholder="MM/YY" class="w-1/2 p-3 border border-gray-400 focus:ring-dark-orchid focus:border-dark-orchid">
                            <input type="text" placeholder="CVC" class="w-1/2 p-3 border border-gray-400 focus:ring-dark-orchid focus:border-dark-orchid">
                        </div>
    ...
    <script>
        // JS Logic for the Multi-Step Modal (CRITICAL FOR FUNCTIONALITY)
