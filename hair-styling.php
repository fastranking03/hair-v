...
<head>
    ...
    <title>HAIR BY LADY H | Styling & Sets</title>
    ...
    <main class="min-h-[80vh]">
        <section class="py-20 md:py-32 bg-white">
            <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <h1 class="font-luxury-serif text-6xl text-center mb-4 text-dark-orchid">Hair Styling & Setting</h1>
                <p class="text-center text-gray-600 mb-12 border-b border-gray-300 pb-8">
                    Perfect your look for any occasion with our bespoke styling services, including hijab and dupatta setting.
                </p>

                <div class="bg-dark-section p-6 border-l-4 border-dark-orchid mb-12 shadow-md">
                    <p class="text-lg font-luxury-serif text-dark-orchid mb-2">Booking Notes</p>
                    <p class="text-sm text-gray-600">
                        Matching Hairpieces, fresh flowers, and Jewellery fitting are available upon request. Additional charges apply for travel (Party Hair).
                    </p>
                </div>
                    ...
                    <div class="space-y-1 bg-dark-section p-4 shadow-sm">
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Party Hair</span>
                                <span class="text-xs text-gray-500">Takes approximately 1 hour (Standard)</span>
                            </div>
                            <span class="text-dark-orchid">£40</span>
                            <button onclick="openBookingModal('Party Hair', '40')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Party Hair (Travel Charges Apply)</span>
                                <span class="text-xs text-gray-500">Duration: 1 hour (Travel fee included)</span>
                            </div>
                            <span class="text-dark-orchid">£45</span>
                            <button onclick="openBookingModal('Party Hair (Travel)', '45')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Hijab Setting</span>
                                <span class="text-xs text-gray-500">Duration: 1 hour</span>
                            </div>
                            <span class="text-dark-orchid">£25</span>
                            <button onclick="openBookingModal('Hijab Setting', '25')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                        <div class="service-list-item">
                            <div class="flex flex-col">
                                <span class="text-lg">Dupatta Setting</span>
                                <span class="text-xs text-gray-500">Duration: 1 hour</span>
                            </div>
                            <span class="text-dark-orchid">£25</span>
                            <button onclick="openBookingModal('Dupatta Setting', '25')" class="glitter-hover text-deep-plum text-xs uppercase px-3 py-1">Book Now</button>
                        </div>
                    </div>
                </div>
    ...
    <div id="enquiry-modal" class="modal fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-sm opacity-0 pointer-events-none" onclick="closeEnquiryModal()">
        <div class="bg-dark-section text-gray-900 p-8 rounded-lg shadow-2xl w-full max-w-md transform scale-95 transition-transform duration-300" onclick="event.stopPropagation()">
            ...
            <form class="flex flex-col gap-4">
                <input type="text" placeholder="Your Name" class="p-3 bg-white border border-gray-400 focus:ring-dark-orchid focus:border-dark-orchid" required>
                <input type="email" placeholder="Your Email" class="p-3 bg-white border border-gray-400 focus:ring-dark-orchid focus:border-dark-orchid" required>
                <textarea placeholder="Your Enquiry / Message" rows="4" class="p-3 bg-white border border-gray-400 focus:ring-dark-orchid focus:border-dark-orchid"></textarea>
